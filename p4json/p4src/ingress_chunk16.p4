...
control MyEgress(inout headers hdr,
    ...
    action fingerprinting(bit<21> hash_base, bit<21> hash_max) {
    ...
    action tre_flag_on(bit<21> b, bit<21> m) {
...
control MyDeparser(packet_out packet, in headers hdr) {
    apply {
        ...
        packet.emit(hdr.u_chunk_token[11].chunk);
        packet.emit(hdr.u_chunk_token[11].token);
        packet.emit(hdr.u_chunk_token[12].chunk);
        packet.emit(hdr.u_chunk_token[12].token);
        packet.emit(hdr.u_chunk_token[13].chunk);
        packet.emit(hdr.u_chunk_token[13].token);
        packet.emit(hdr.u_chunk_token[14].chunk);
        packet.emit(hdr.u_chunk_token[14].token);
        packet.emit(hdr.u_chunk_token[15].chunk);
        packet.emit(hdr.u_chunk_token[15].token);
        packet.emit(hdr.u_chunk_token[16].chunk);
        packet.emit(hdr.u_chunk_token[16].token);
        packet.emit(hdr.u_chunk_token[17].chunk);
        packet.emit(hdr.u_chunk_token[17].token);
        packet.emit(hdr.u_chunk_token[18].chunk);
        packet.emit(hdr.u_chunk_token[18].token);
        packet.emit(hdr.u_chunk_token[19].chunk);
        packet.emit(hdr.u_chunk_token[19].token);

...
for i in ${dist_type[@]}; do
    for j in ${num_of_packets[@]}; do
        ...
        gnome-terminal --command="sudo python p4runtime/tre_controller.py"
        sleep 3
        /home/p4/behavioral-model/targets/simple_switch/sswitch_CLI --thrift-port 9090 < p4runtime/rule
        sleep 3

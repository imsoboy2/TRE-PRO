...
#         sudo simple_switch --device-id 1 -i 1@veth0 -i 3@veth2 -i 10@veth10 --log-console --thrift-port 9090 p4json/tre_ingress_cache${i}.json &
#         sleep 3
...
#         sudo simple_switch --device-id 1 -i 1@veth0 -i 3@veth2 -i 10@veth10 --log-console --thrift-port 9090 p4json/tre_ingress_chunk${i}.json &
#         sleep 3
#         /home/p4/behavioral-model/targets/simple_switch/sswitch_CLI --thrift-port 9090 < rule
...
#         sudo python receive.py --fname=bkt${i}_pktnum${j} > logs/bucket_receive_${i}_${j} &
#         sudo python Netre/tre_controller.py --bktnum=${i} > logs/bucket_tre_${i}_${j} &
#         sudo simple_switch --device-id 1 -i 1@veth0 -i 3@veth2 -i 10@veth10 --log-console --thrift-port 9090 p4json/tre_ingress.json &
#         sleep 3
#         /home/p4/behavioral-model/targets/simple_switch/sswitch_CLI --thrift-port 9090 < rule
